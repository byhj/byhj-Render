...
MainWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    return D3D12Render::GetApp()->MsgProc(hwnd, msg, wParam, lParam);
}

D3D12Render* D3D12Render::mApp = nullptr;
D3D12Render* D3D12Render::GetApp()
{
    return mApp;
}

D3D12Render::D3D12Render(HINSTANCE hInstance)
:	mhAppInst(hInstance)
{
    // Only one D3D12Render can be constructed.
    assert(mApp == nullptr);
    mApp = this;
}
...
HINSTANCE D3D12Render::AppInst()const
{
	return mhAppInst;
}

HWND D3D12Render::MainWnd()const
{
	return mhMainWnd;
}

float D3D12Render::AspectRatio()const
{
...
LRESULT D3D12Render::MsgProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	switch( msg )
	{
...
bool D3D12Render::InitMainWindow()
{
	WNDCLASS wc;
