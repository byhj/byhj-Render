...
void Wall::init(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContect)
{
	init_buffer(pD3D11Device, pD3D11DeviceContect);
}

void Wall::render(ID3D11DeviceContext *pD3D11DeviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
bool Wall::init_buffer(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext)
{
	HRESULT hr;

	///////////////////////////Index Buffer ////////////////////////////////
	load_model("../../media/objects/Wall.txt");
...
bool Wall::load_model(char *modelFile)
{
	std::ifstream fin;
	char ch;
	int i;
