...
void Bath::init(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext)
{
...
void Bath::render(ID3D11DeviceContext *pD3D11DeviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
bool Bath::init_buffer(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext)
{
	HRESULT hr;

	///////////////////////////Index Buffer ////////////////////////////////
	load_model("../../media/objects/bath.txt");
...
bool Bath::load_model(char *modelFile)
{
	std::ifstream fin;
	char ch;
	int i;
