...
namespace byhj {
	...
	void Scene::init(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext, HWND hWnd)
	{
	...
	void Scene::render(ID3D11DeviceContext *pD3D11DeviceContext, const D3DMVPMatrix &matrix)
	{
	...
	void Scene::init_buffer(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext)
	{
		ModelMgr::getInstance()->loadD3DModel("cyborg/cyborg.obj", pD3D11Device, pD3D11DeviceContext);
	}


	void Scene::init_shader(ID3D11Device *pD3D11Device, HWND hWnd)
	{
		HRESULT result;
