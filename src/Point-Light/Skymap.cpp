...
void Skymap::render(ID3D11DeviceContext *pD3D11DeviceContext, const D3DMVPMatrix& mvpMatrix)
{
...
void Skymap::init_texture(ID3D11Device *pD3D11Device)
{
	...
	m_pSkymapTexSRV = TextureMgr::getInstance()->loadD3DTexture(pD3D11Device, "skymap.dds");
