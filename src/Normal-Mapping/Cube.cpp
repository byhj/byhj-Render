...
namespace byhj
{
 ...
 static const GLsizei VertexSize = sizeof(VertexData);
	...
	void Cube::render()
	{
		...
		colorTex = TextureMgr::getInstance()->getOGLTextureByName("four_shapes_color.png");
		normalTex = TextureMgr::getInstance()->getOGLTextureByName("four_shapes_normal.png");
	...
	{
		TextureMgr::getInstance()->loadOGLTexture("four_shapes_color.png");
		TextureMgr::getInstance()->loadOGLTexture("four_shapes_normal.png");
