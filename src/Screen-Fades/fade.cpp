...
namespace byhj
{
	...
	void Fade::render(ID3D11DeviceContext *pD3D11DeviceContext, ID3D11ShaderResourceView *pTexture, 
	...
	bool Fade::init_shader(ID3D11Device *pD3D11Device, HWND hWnd)
	{
		...
		FadeShader.attach(D3D_VERTEX_SHADER,  L"fade.vsh", "VS", "vs_5_0");
		FadeShader.attach(D3D_PIXEL_SHADER,   L"fade.psh", "PS", "ps_5_0");
		FadeShader.end();
