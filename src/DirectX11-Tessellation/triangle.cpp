...
void Triangle::init_buffer(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext)
{
	...
	/////////////////////////////////Index Buffer ///////////////////////////////////////
	m_IndexCount = 3;
	UINT *IndexData= new UINT[m_IndexCount];
...
void Triangle::init_shader(ID3D11Device *pD3D11Device, HWND hWnd)
{
	...
	TriangleShader.attach(D3D_VERTEX_SHADER, L"light.vsh", "VS", "vs_5_0");
	TriangleShader.attach(D3D_HULL_SHADER,   L"light.hsh", "HS", "hs_5_0");
	TriangleShader.attach(D3D_DOMAIN_SHADER, L"light.dsh", "DS", "ds_5_0");
	TriangleShader.attach(D3D_PIXEL_SHADER,  L"light.psh", "PS", "ps_5_0");
	TriangleShader.end();
